...
class UserAdmin(admin.ModelAdmin):
    list_per_page = 15
    list_display = ["pk","email","name","password","phone_num","gender","birthday","age","address","picture","createtime","user_status","isDelete"]
...
class GoodsAdmin(admin.ModelAdmin):
    ...
    list_display = ["pk","Goods_num","Goods_name","Goods_price","Goods_count","Goods_pro_date",
                    "Goods_safe_date","Goods_status","Goods_location","types_id","supplier_id","user_id"]
...
class TypesAdmin(admin.ModelAdmin):
    list_per_page = 15
    list_display = ["pk","typename","typeimg"]